...
public class AESUtil {
    ...
    public static String encrypt(String encodeRules,String content){
        try {
            ...
            SecretKey key = generateKey(encodeRules);
            //6.根据指定算法AES自成密码器
     ...
     * @return
     */
    public static String getSecretKeyBase64(String key) {
        try {
    ...
    private static SecretKey generateKey(String encodeRules) throws Exception {
